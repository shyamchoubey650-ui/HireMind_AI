...
//   if (!isoString) return '';
//   const utcString = /Z$|[+-]\d{2}:\d{2}$/.test(isoString)
//     ? isoString
//     : `${isoString}Z`;
...
//           {monthName} {year}
//         </div>
//         <div className="cal-schedule-pill">
...
//       <style>{`
//         /* Hide parent Modal default close button so only our styled button shows */
//         .modal-close,
...
//         /* Ensure parent modal wrapper has no restrictive clipping */
//         .modal-box {
...
//         /* ══════════════════════════════════════════════════════════
//            PREMIUM TIMELINE CALENDAR MODAL
//            ══════════════════════════════════════════════════════════ */
//         .atm-modal-container {
//           background: #080d1a;
...
//         /* Fully Visible Custom Close Button */
//         .atm-close-x {
//           position: absolute;
//           right: 0px;
//           top: -4px;
...
//         .atm-close-x:hover svg {
//           stroke: #ffffff;
//         }

//         /* Inner Calendar Section */
//         .cal-card-wrapper {
//           background: #0b1122;
...
//         /* Assigned Date Badge (Purple Glow) */
//         .day-assigned {
...
//         /* Submitted Date Badge (Cyan Glow) */
//         .day-submitted {
...
//           gap: 8px;
//           cursor: pointer;
//           box-shadow: 0 4px 18px rgba(76, 29, 149, 0.4);
//           transition: all 0.2s ease;
//         }
...
//           Recruiters may assign a skills assessment after screening. Assessments open in a dedicated secure tab — scoring is instant.
//         </p>
//       </div>
...
//             {subs.length === 0 ? 'No assessments assigned yet' : 'No assessments match your search'}
//           </div>
//         </div>
//       )}
...
//                 <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 15, color: '#f8fafc', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
//                   {jobTitle}
//                 </div>
//                 <div
...
//                   <div style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: 17, color: `var(--${color})`, whiteSpace: 'nowrap' }}>
//                     {s.score}%
//                   </div>
//                   <div style={{ fontSize: 9, color: '#94a3b8', textTransform: 'uppercase', whiteSpace: 'nowrap' }}>
//                     {s.submission_type && s.submission_type !== 'MANUAL' ? 'Auto-submitted' : 'Score'}
//                   </div>
//                 </div>
//                 <div className="circular-progress-ring" style={{ background: `conic-gradient(var(--${color}) ${s.score * 3.6}deg, rgba(255,255,255,0.06) 0deg)` }}>
//                   <div style={{ width: '30px', height: '30px', background: '#090b16', borderRadius: '50%' }} />
//                 </div>
//               </div>
//             ) : (
//               <button
//                 className="small"
//                 onClick={() => handleStartAssessment(s.assessment_id)}
//                 style={{ flexShrink: 0, padding: '9px 18px', borderRadius: '10px', whiteSpace: 'nowrap' }}
//               >
...
//                 <div className="atm-info-left">
//                   <span className="atm-info-badge badge-assigned">
//                     <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//                       <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
//                       <circle cx="12" cy="7" r="4" />
//                     </svg>
//                   </span>
//                   <span className="atm-label-assigned">Assigned:</span>
//                 </div>
...
//                 <div className="atm-info-row">
//                   <div className="atm-info-left">
//                     <span className="atm-info-badge badge-submitted">
//                       <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//                         <line x1="22" y1="2" x2="11" y2="13" />
//                         <polygon points="22 2 15 22 11 13 2 9 22 2" />
//                       </svg>
//                     </span>
//                     <span className="atm-label-submitted">Submitted:</span>
//                   </div>
//                   <span className="atm-info-value">
...
//                 <div className="atm-info-row">
//                   <div className="atm-info-left">
//                     <span className="atm-info-badge badge-security">
//                       <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
//                         <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
//                       </svg>
//                     </span>
//                     <span className="atm-label-security">Security events:</span>
//                   </div>
